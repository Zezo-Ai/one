...
import { AggregatedView } from '@modules/containers/Hosts/Details/aggregated'

export const DetailsDrawer = ({ selectedHosts = [], ...handlers }) => {
  const isMultiple = selectedHosts?.length > 1
  const isOpen = selectedHosts?.length > 0
