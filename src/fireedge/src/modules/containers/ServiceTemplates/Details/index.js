...
import { SingleView } from '@modules/containers/ServiceTemplates/Details/single'
import { AggregatedView } from '@modules/containers/ServiceTemplates/Details/aggregated'
...
export const DetailsDrawer = ({
  ...
  const isOpen = selectedTemplates?.length > 0
