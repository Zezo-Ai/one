...
} from '@modules/components/Forms/Group/AddVLANRuleForm/Steps/General'

import VNTemplatesStep, {
  STEP_ID as VNTEMPLATETABLE_ID,
} from '@modules/components/Forms/Group/AddVLANRuleForm/Steps/VNTemplatesTable'

import { createSteps } from '@UtilsModule'

const Steps = createSteps([General, VNTemplatesStep], {
  // const Steps  = createSteps(
  //   ({isUpdate = false, oneConfig, adminGroup, restrictedAttributesType, nameParentAttribute}) => {
  //     const steps = []
  //     steps.push(() => General())
  //     steps.push(() => VNTemplatesStep({update: isUpdate}))
  //     return steps
  //   },
  // {
  // for the updates
